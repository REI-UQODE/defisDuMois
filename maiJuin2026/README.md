...
Le premier défi de l'été 2026 sera un parseur JSON!
...
Le but de ce défi est de programmer un **parseur JSON dans le langage de votre choix**.

Il existe évidemment déjà plusieurs implémentation d'un tel parseur, certaines meilleures que d'autres. Vous pouvez vous en inspirer, mais nous vous demandons d'**écrire le vôtre** vous-même. Le moins de bibliothèques externes vous utiliserez, le plus de points vous aurez!

Une bonne manière de marquer des points est d'avoir un parseur rapide et efficace. De plus, la complétude et la portabilité de votre programme peuvent aussi valoir des points!
